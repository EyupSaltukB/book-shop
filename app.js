  ...
  bookList.forEach((book, index) => {
    ...
    <div class="row book-card">
      ...
      <div class="col-6 d-flex flex-column justify-content-between">
        ...
        <button class="btn-green" onclick="addBookToBasket(${
          book.id
        })">Sepete Ekle</button>
      </div>
    </div>
...
const listBasketItems = () => {
  ...
  const basketCountEl = document.querySelector(".basket-count").innerHTML = 
  ...
  basketList.forEach(item => {
    ...
    <li class="basket-item">
          ...
          <div class="basket-item-info">
            ...
            <span class="book-remove" onclick="removeItemToBasket(${item.product.id})">sil</span>
          </div>
  ...
  if (findedBook) {
    ...
    if (basketAlreadyIndex == -1) {
      ...
      if (
        ...
        alert("Üzgünüz, yeterli stokumuz yok.");
        return;
      }
    }
    listBasketItems();
